...
function AppointmentsPage() {
  ...
  const handleDentistSelect = (dentistId: string) => {
    ...
    // reset other selections when dentist changes
    setSelectedDate("");
    setSelectedTime("");
    setSelectedType("");
  };
  ...
  const handleBookAppointment = async () => {
    if (!selectedDentistId || !selectedDate || !selectedTime || !selectedType) {
      toast.error(
        "Please complete all steps before confirming your appointment.",
      );
      return;
    }
    ...
    bookAppointmentMutation.mutate(
      ...
      },
      {
        onSuccess: async (appointment) => {
          // store the booked appointment details to show in the confirmation modal
          setBookedAppointment(appointment);

          // todo: send eamil using resend
          try {
