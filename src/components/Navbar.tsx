      ...
      <div className="max-w-7xl mx-auto px-8 h-16 flex justify-between items-center">
            ...
            {navLinks.map((link) => {
              ...
              return (
                <Link
                  key={link.href}
                  href={link.href}
                  className={`relative flex items-center gap-2 px-5 py-2 rounded-full transition-all duration-300 group ${
        ...
        <div className="flex items-center gap-6">
          <div className="flex items-center gap-4">
            ...
            <motion.div 
              whileHover={{ x: -2 }}
              className="hidden lg:flex flex-col items-end gap-1 cursor-default group/text"
            >
              ...
              <div className="flex items-center gap-2">
                ...
                {/* 🔥 TOGGLE BUTTON (ONLY FOR YOU) */}
                {isOwner && (
                  <button
                    onClick={() => setIsAdminMode(!isAdminMode)}
                    className="text-[10px] px-3 py-1 rounded-full border border-primary/20 bg-primary/10 hover:bg-primary/20 transition-all duration-300"
                  >
                    {isAdminMode ? "Patient Mode" : "Admin Mode"}
                  </button>
                )}
