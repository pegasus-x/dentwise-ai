...
function Header() {
  return <nav className="fixed top-0 right-0 left-0 z-50 px-6 py-2 border-b border-border/50 bg-background/80
  backdrop-blur-md h-16">

  <div className="max-2-6xl mx-auto flex justify-between items-center">
